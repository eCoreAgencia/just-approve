    ...
    $.getJSON(data, function(data) {
        $.each(data, function(key, val) {
            ...
            // Catch Profundidade Val //
                ...
                $('<tr class="'+valProfundidadePP+'" idVal="'+valProfundidadeP+'"></tr>').insertAfter('.tabela .profundidade tr.my-thead');
                $('<tr class="'+valProfundidadePP+'" idVal="'+valProfundidadeM+'"></tr>').insertAfter('.tabela .profundidade tr.my-thead');
                $('<tr class="'+valProfundidadePP+'" idVal="'+valProfundidadeG+'"></tr>').insertAfter('.tabela .profundidade tr.my-thead');
                $('<tr class="'+valProfundidadePP+'" idVal="'+valProfundidadeGG+'"></tr>').insertAfter('.tabela .profundidade tr.my-thead');
            // Catch Profundidade Val //
            ...
            $('.pic-tabela').html('<svg>'+tabelaSVG+'</svg>');
